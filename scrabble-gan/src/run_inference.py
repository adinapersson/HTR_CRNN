...
def main():
    latent_dim = 128
    char_vec = 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZåäöÅÄÖ'
    # path_to_saved_model = '/home/ubuntu/workspace/scrabble-gan/res/out/big_ac_gan/model/generator_15'
    path_to_saved_model = './scrabble-gan-master/res/out/big_ac_gan/model/generator_7'
    ...
    for idx in range(1):
        fake_labels = []
        words = [sample_string] * batch_size
